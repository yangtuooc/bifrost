...
- "Video" refers to Video API operations such as generating, retrieving, downloading, deleting, and listing videos. Some providers support only a subset of these sub-operations; see each provider page for details.
