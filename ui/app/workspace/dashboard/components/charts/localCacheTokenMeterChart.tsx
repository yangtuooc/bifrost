				...
				{hasData && (
					<div>
						<div className="flex flex-col items-center pt-1 leading-none">
							...
							<div className="mt-1 text-[11px] text-zinc-400">{t("dashboard.cache.localCacheRequests")}</div>
						</div>
